...
export default function AddCar(props) {
  ...
  if (
    (EditItemRef.current !== '' && props.title === 'Edit Car') ||
    ...
    return (
      <BigContainer>
        ...
        <Pwd>
          <Link to="/admin">Cars</Link> {`>`}{' '}
          <Link to="/admin/list">List Car</Link> {`>`}{' '}
          {props.title === 'Edit Car' ? (
            <span>Edit Car</span>
          ) : (
        ...
        <Form onSubmit={submit}>
          <FormItem>
            ...
            <input
              ...
              defaultValue={
                props.title === 'Edit Car' ? EditItemRef.current.name : ''
              }
              required
            ></input>
          </FormItem>
          <FormItem>
            ...
            <input
              ...
              defaultValue={
                props.title === 'Edit Car' ? EditItemRef.current.price : ''
              }
              required
            ></input>
          </FormItem>
          <FormItem>
            ...
            <InputContainer>
              <input
                ...
                id="foto"
              />
              {dataRef.current.foto ? (
                <label htmlFor="foto">{dataRef.current.foto.name}</label>
              ) : (
          ...
          <Buttons className="buttons">
            ...
            {Object.keys(dataRef.current).length === 5 &&
            dataRef.current.cek ? (
