      ...
      <Routes>
        ...
        <Route element={<AdminPrivateRouter></AdminPrivateRouter>}>
          ...
          <Route
            exact
            path="/admin/list"
            element={<AdminListCar></AdminListCar>}
          />
          <Route
            exact
            path="/admin/list/add"
            element={<AddCar {...addCarProps}></AddCar>}
          />
          <Route
            exact
            path="/admin/list/edit/:id"
            element={<AddCar {...editCarProps}></AddCar>}
          />
        </Route>
        ...
        <Route
          exact
          path="/login"
          element={<UserLogin {...userLoginProps} />}
        />
        <Route
          exact
          path="/register"
          element={<UserLogin {...userRegisProps} />}
        />
