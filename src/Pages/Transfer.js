      ...
      <Container>
        ...
        <Left>
          <CountDown>
            ...
            <h3>
              <span>
                {pembayaran[0] < 10 ? `0${pembayaran[0]}` : pembayaran[0]}
              </span>
              <span>:</span>
              <span>
                {pembayaran[1] < 10 ? `0${pembayaran[1]}` : pembayaran[1]}
              </span>
              <span>:</span>
              <span>
                {pembayaran[2] < 10 ? `0${pembayaran[2]}` : pembayaran[2]}
              </span>
            </h3>
          </CountDown>
          <Info>
          ...
          <Instruksi>
            ...
            {active[0] ? (
              <ul>
                ...
                <li>
                  menu “Transaksi Lainnya” – "Transfer” – “Ke Rek {text} Virtual
                  Account”
                </li>
                <li>
                  {' '}
                  Masukkan nomor {text} Virtual Account: 70020+Order ID
                  <span>Contoh</span>{' '}
                  <span>
                    {' '}
          ...
          {konfirmasi ? (
            <Upload>
              <Title>
                ...
                <div>
                  <h3>
                    <span>{bukti[0] < 10 ? `0${bukti[0]}` : bukti[0]}</span>
                    <span>:</span>
                    <span>{bukti[1] < 10 ? `0${bukti[1]}` : bukti[1]}</span>
                  </h3>
                </div>
              </Title>
              <p>
