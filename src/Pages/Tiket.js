...
export default function Tiket() {
  ...
  useEffect(() => {
    let getCustomerData = async () => {
      try {
        let rawData = await window.fetch(`https://bootcamp-rent-car.herokuapp.com/customer/order/${customerIdRef.current}`, {
          method: "GET",
          headers: {
        ...
        <Container>
          ...
          <Invoice>
            <div className='header'>
              ...
              <PDFDownloadLink document={<MyDocument customerData={customerDataRef.current}/>} fileName="payment.pdf">
